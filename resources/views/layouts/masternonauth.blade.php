        ...
        <div class="row g-0">
                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="" class="d-block auth-logo">
                                    <img src="{{url('public/assets/images/os.png')}}" alt="" height="28"> <span
                                        class="logo-txt"></span>
                                </a>
                            </div>
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0"> All Rights received © PawLog (Pvt) Ltd. <br> Design & Develop by
                                    <a href="#!" class="">PawLog (Pvt) Ltd.</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xxl-9 col-lg-8 col-md-7">
                <div class="auth-bg pt-md-5 p-4 d-flex">
                    <div class="bg-overlay" style="background-image: url("{{url('public/assets/images/kt.jpg')}}");
